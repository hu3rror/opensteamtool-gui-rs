...
pub struct Strings {
    ...
    /// 补丁控制台卡片标题（原「本地应用状态」卡片，T5 合并操作区）。
    pub patch_console_title: &'static str,
    ...
    /// Steam 进程状态徽章：未运行。
    pub status_steam_not_running: &'static str,
    ...
    /// 「立即更新」主按钮（流程术语「下载并解压」见 CONTEXT.md）。
...
impl Strings {
    ...
    fn en() -> Self {
        Self {
            ...
            browse: "Browse...",
            patch_console_title: "Patch Console",
            ...
            status_steam_running: "Steam Running",
            status_steam_not_running: "Steam Not Running",
